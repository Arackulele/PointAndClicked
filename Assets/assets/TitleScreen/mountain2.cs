...
public class mountain2 : MonoBehaviour
{
    ...
    IEnumerator parallax()
    {
        ...
        while (move == true)
        {
            ...
            yield return gameObject.transform.position = new Vector3(gameObject.transform.position.x+0.07f, gameObject.transform.position.y, gameObject.transform.position.z);
